...
class Actor:
    ...
    def build_model(self):
        ...
        net = layers.Dense(units=256, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(net)
        net = layers.BatchNormalization()(net)
        net = layers.Dense(units=256, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(net)
...
class Critic:
    ...
    def build_model(self):
        ...
        net_actions = layers.Dense(units=256, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(net_actions)
